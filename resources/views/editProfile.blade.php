                ...
                <div class="row align-items-center">
                    ...
                    <form action="/editProfile" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="name" maxlength="30" class="form-control form-control-lg bg-light fs-6" placeholder="User name">
                        </div>
                        <div class="input-group mb-3">
                            <input type="text" name="contact" maxlength="30" class="form-control form-control-lg bg-light fs-6" placeholder="Contact">
                        </div>
                        <div class="input-group mb-3">
                            <input type="password" name="password" maxlength="30" class="form-control form-control-lg bg-light fs-6" placeholder="Password">
                        </div>
                        <div class="input-group mb-3">
                            <input type="password" name="password_confirmation" maxlength="30" class="form-control form-control-lg bg-light fs-6" placeholder="Confirm Password">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn_mc w-100 fs-6">Save</button>
                        </div>
                    </form>
                    <div class="input-group mb-3">
