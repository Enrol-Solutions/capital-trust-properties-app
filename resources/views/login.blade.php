       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <input name="email" maxlength="30" type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Email address">
                </div>
                @error('email')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <div class="input-group mb-1">
                    <input name="password" maxlength="30" type="password" class="form-control form-control-lg bg-light fs-6" placeholder="Password">
                </div>
                </div>
                @error('password')
                    <span class="text-danger">{{ $message }}</span>
                ...
                <div class="input-group mb-3">
                    <button class="btn btn-lg btn_mc w-100 fs-6">Login</button>
                </div>
                </form>
                <div class="input-group mb-3">
