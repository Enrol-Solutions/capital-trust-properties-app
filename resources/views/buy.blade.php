        ...
        <div class="container">
            ...
            <div class="row mb-4 xs-mb-10 pt-9" id="rentals">
                <div class="col-12 text-center" data-anime="{ &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    ...
                    <h3 class="alt-font text-dark-gray fw-500 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">No items for <span class="fw-700 text-highlight">sell<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span></h3>
                    @elseif($type=='houses')
                    <h3 class="alt-font text-dark-gray fw-500 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">Latest {{$type}} for <span class="fw-700 text-highlight">sell<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span></h3>
                    @elseif($type=='other')
                    <h3 class="alt-font text-dark-gray fw-500 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">Latest properties for <span class="fw-700 text-highlight">sell<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span></h3>
                    @else
                    <h3 class="alt-font text-dark-gray fw-500 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">Latest {{$type}}s for <span class="fw-700 text-highlight">sell<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span></h3>
                    @endif
                </div>
            </div>
            <div class="container">
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    ...
                                    <div class="col text-end">
                                        @if(strlen($property->asking_price)< 4)
                                            <span class="fs-24 alt-font text-dark-gray fw-700 mb-0">LKR {{$property->asking_price}} .00 </span>
                                            @elseif(strlen($property->asking_price)< 6)
                                                <span class="fs-18 alt-font text-dark-gray fw-700 mb-0">LKR {{$property->asking_price}} .00 </span>
                                                @else
                                                <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">LKR {{$property->asking_price}} .00 </span>
                                                @endif
                                    </div>
                                </div>
                            </div>
